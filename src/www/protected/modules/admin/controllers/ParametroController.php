...
/**
 * Controlador para el modelo Parametro
 */
class ParametroController extends AdminController {
  ...
  public function actionAgregar()
  {
    ...
    if(isset($_POST['Parametro'])) {
      ...
      if($model->save()) {
        $this->redirect(array('/admin/parametro/ver', 'id' => $model->id));
      }
    }
  ...
  public function actionEliminar($id)
  {
    ...
    if(!isset($_GET['ajax']))
      $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/admin/parametro/'));
  }
