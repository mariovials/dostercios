...
/**
 * Controlador para el modelo Descarga
 */
class DescargaController extends AdminController {
  ...
  public function actionAgregar()
  {
    ...
    if(isset($_POST['Descarga'])) {
      ...
      if($model->save()) {
        $this->redirect(array('/admin/descarga/ver', 'id' => $model->id));
      }
    }
  ...
  public function actionEliminar($id)
  {
    ...
    if(!isset($_GET['ajax']))
      $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/admin/descarga/'));
  }
