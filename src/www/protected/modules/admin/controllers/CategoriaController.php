...
/**
 * Controlador para el modelo Categoria
 */
class CategoriaController extends AdminController {
  ...
  public function actionAgregar()
  {
    ...
    if(isset($_POST['Categoria'])) {
      ...
      if($model->save()) {
        $this->redirect(array('/admin/categoria/ver', 'id' => $model->id));
      }
    }
  ...
  public function actionEliminar($id)
  {
    ...
    if(!isset($_GET['ajax']))
      $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/admin/categoria/'));
  }
