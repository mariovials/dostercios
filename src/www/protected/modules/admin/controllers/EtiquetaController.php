...
/**
 * Controlador para el modelo Etiqueta
 */
class EtiquetaController extends AdminController {
  ...
  public function actionAgregar()
  {
    ...
    if(isset($_POST['Etiqueta'])) {
      ...
      if($model->save()) {
        $this->redirect(array('/admin/etiqueta/ver', 'id' => $model->id));
      }
    }
  ...
  public function actionEliminar($id)
  {
    ...
    if(!isset($_GET['ajax']))
      $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/admin/etiqueta/'));
  }
