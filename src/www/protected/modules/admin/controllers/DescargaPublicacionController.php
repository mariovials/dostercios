...
/**
 * Controlador para el modelo DescargaPublicacion
 */
class DescargaPublicacionController extends AdminController {
  ...
  public function actionIndex()
  {
    ...
    $dataProvider = new CActiveDataProvider('DescargaPublicacion');
  ...
  public function actionAgregar()
  {
    ...
    $model = new DescargaPublicacion;

    if(isset($_POST['DescargaPublicacion'])) {
      $model->attributes = $_POST['DescargaPublicacion'];
      if($model->save()) {
        $this->redirect(array('/admin/descarga-publicacion/ver', 'id' => $model->id));
      }
    }
  ...
  public function actionEliminar($id)
  {
    ...
    if(!isset($_GET['ajax']))
      $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/admin/descarga-publicacion/'));
  }
