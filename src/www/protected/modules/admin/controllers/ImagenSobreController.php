...
/**
 * Controlador para el modelo ImagenSobre
 */
class ImagenSobreController extends AdminController {
  ...
  public function actionIndex()
  {
    ...
    $dataProvider = new CActiveDataProvider('ImagenSobre');
  ...
  public function actionAgregar()
  {
    ...
    $model = new ImagenSobre;

    if(isset($_POST['ImagenSobre'])) {
      $model->attributes = $_POST['ImagenSobre'];
      if($model->save()) {
        $this->redirect(array('/admin/imagen-sobre/ver', 'id'=>$model->id));
      }
    }
  ...
  public function actionEliminar($id)
  {
    ...
    if(!isset($_GET['ajax']))
      $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/admin/imagen-sobre'));
  }
