...
<div class="ficha produccion">
  ...
  <div class="datos">
    ...
    <div class="fila">
      <?php if(in_array('categoria', $campos)): ?>
      <div class="campo categoria">
        <div class="label"><?php echo $model->getAttributeLabel('categoria'); ?></div>
        <div class="value"><?php echo $model->categoria->nombre; ?></div>
      </div>
      <?php endif; ?>
    ...
    <div class="fila">
      ...
      <div class="campo texto">
        ...
        <div class="value"><?php echo nl2br($model->texto); ?></div>
      </div>
      <?php endif; ?>
    </div>

    <div class="fila">
      <?php if(in_array('cita', $campos)): ?>
      <div class="campo cita">
        <div class="label"><?php echo $model->getAttributeLabel('cita'); ?></div>
        <div class="value"><?php echo nl2br($model->cita); ?></div>
      </div>
      <?php endif; ?>
    </div>
    ...
    <div class="fila grande">
      ...
      <div class="campo video grande">
        ...
        <div class="value grande"><?php echo $model->video; ?></div>
      </div>
      <?php endif; ?>
    </div>
    ...
    <div class="fila">
      ...
      <div class="campo resumen">
        ...
        <div class="value"><?php echo nl2br($model->resumen); ?></div>
      </div>
      <?php endif; ?>
    </div>
