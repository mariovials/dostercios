<?php
/**
 * @var $this EntrevistaController * @var $model Entrevista * @var $form ActiveForm
 */
Yii::app()->clientScript->registerCoreScript('summernote');
Yii::app()->clientScript->registerScriptFile('jquery.form');
$this->cargar_js('subir_foto_entrevista.js');
$this->cargar_js('common.js');
$this->cargar_js('entrevista.js');
?>
...
<div class="set">
    ...
    <div class="campo url">
      ...
      <div class="value">
        <span style="color: #777">
          <?php echo Yii::app()->request->hostInfo . BASE_URL ?>/entrevista/
        </span>
  ...
  <div class="fila">
    ...
    <div class="campo">
      <div class="label">
      <?php echo $form->labelEx($model, 'eliminarMiniatura'); ?>
      </div>
      <?php echo $form->description($model, 'eliminarMiniatura'); ?>
      <div class="value">
      <?php echo $form->checkBox($model, 'eliminarMiniatura'); ?>
      </div>
      <?php echo $form->suggestion($model, 'eliminarMiniatura'); ?>
      <?php echo $form->error($model, 'eliminarMiniatura'); ?>
    </div>
  </div>
